...
class TenantDatabaseSeeder extends Seeder
{
    ...
    private function seedPermissions(): void
    {
        $permissions = [
            ...
            ['name' => 'hrm.leave.write',       'description' => 'Submit own leave requests'],
            ['name' => 'hrm.leave.approve',     'description' => 'Approve / reject leave requests'],
            ['name' => 'hrm.leave.manage',      'description' => 'Manage leave-type catalog'],
